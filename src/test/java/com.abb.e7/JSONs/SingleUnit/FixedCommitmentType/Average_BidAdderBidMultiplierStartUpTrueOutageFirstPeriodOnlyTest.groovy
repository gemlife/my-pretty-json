...
class Average_BidAdderBidMultiplierStartUpTrueOutageFirstPeriodOnlyTest {
  ...
  public void post() {
    ...
    def pricePatternsSecondBlock = ["^66\\.0(\\d+)", "^68\\.4(\\d+)", "^71\\.9(\\d+)", "^82\\.4(\\d+)"]
    def pricePatternsThirdBlock = ["^66\\.0(\\d+)", "^68\\.4(\\d+)", "^71\\.9(\\d+)", "^82\\.4(\\d+)"]
