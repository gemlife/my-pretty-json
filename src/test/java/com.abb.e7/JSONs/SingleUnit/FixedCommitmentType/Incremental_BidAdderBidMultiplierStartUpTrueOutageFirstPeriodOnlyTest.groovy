...
class Incremental_BidAdderBidMultiplierStartUpTrueOutageFirstPeriodOnlyTest {
  ...
  public void post() {
    ...
    def pricePatternsSecondBlock = ["^65\\.5(\\d+)", "^66\\.6(\\d+)", "^68\\.4(\\d+)", "^71\\.9(\\d+)"]
    def pricePatternsThirdBlock = ["^65\\.5(\\d+)", "^66\\.6(\\d+)", "^68\\.4(\\d+)", "^71\\.9(\\d+)"]
    def quantityPatternsSecondBlock = ["100\\.0", "150\\.0", "225\\.0", "300\\.0"]
    def quantityPatternsThirdBlock = ["100\\.0", "150\\.0", "225\\.0", "300\\.0"]
