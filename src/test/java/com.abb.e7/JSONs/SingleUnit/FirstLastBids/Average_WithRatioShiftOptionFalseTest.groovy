package com.abb.e7.JSONs.SingleUnit.FirstLastBids
...
class Average_WithRatioShiftOptionFalseTest {
  ...
  public void post() {
    ...
    List<Pattern> pricePatterns = ["^58\\.4(\\d+)", "^61\\.9(\\d+)", "^65\\.3(\\d+)", "^75\\.6(\\d+)"] as List<Pattern>
