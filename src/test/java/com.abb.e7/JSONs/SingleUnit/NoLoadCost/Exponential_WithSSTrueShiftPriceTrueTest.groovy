...
class Exponential_WithSSTrueShiftPriceTrueTest {
  ...
  public void post() {
    ...
    def pricePatternsFistBlock = ["^67\\.3(\\d+)", "^68\\.4(\\d+)", "^88\\.3(\\d+)","^88\\.3(\\d+)"]as List<Pattern>
    def pricePatternsSecondBlock = ["^67\\.3(\\d+)", "^68\\.4(\\d+)", "^88\\.3(\\d+)","^88\\.3(\\d+)"]
    def pricePatternsThirdBlock = ["^67\\.3(\\d+)", "^68\\.4(\\d+)", "^88\\.3(\\d+)","^88\\.3(\\d+)"]
