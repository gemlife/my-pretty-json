...
class Polynomial_ShiftPriceFalseWithDFCMAndHandlingCostEmissionForStationTest {
  ...
  public void post() {
    ...
    List<Pattern> pricePatterns = ["^92\\.8(\\d+)", "^114\\.0(\\d+)", "^154\\.7(\\d+)", "^208\\.9(\\d+)"] as List<Pattern>
