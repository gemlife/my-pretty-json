...
class Average_SSTruePZFalseWithRegularRatioTest {
  ...
  public void post() {
    ...
    def pricePatternsFistBlock = ["^44\\.6", "^47\\.7(\\d+)", "^50\\.8(\\d+)", "^60\\.2"] as List<Pattern>
    def pricePatternsSecondBlock = ["^47\\.7(\\d+)", "^50\\.8(\\d+)", "^60\\.2"]
    def pricePatternsThirdBlock = ["^60\\.2"]
