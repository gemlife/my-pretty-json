...
class Exponential_MoreCoefficientsTest {
  ...
  def firstPeriod = new PeriodsDataInput(
      ...
      incMinCap: 25.0,
      incMaxCap: 200.0,
      coefficients: [325.0, 0.0, 0.0, 0.0, 0.0],
  )
  ...
  public void post() {
    ...
    def errorMessage = "Coefficients for exponential calculations should be set and its number should be maximum four"
