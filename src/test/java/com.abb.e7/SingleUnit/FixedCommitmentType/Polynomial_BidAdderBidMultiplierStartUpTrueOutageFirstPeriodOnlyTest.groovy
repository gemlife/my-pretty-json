...
class Polynomial_BidAdderBidMultiplierStartUpTrueOutageFirstPeriodOnlyTest {
  ...
  public void post() {
    ...
    def pricePatternsSecondBlock = ["^93\\.6(\\d+)", "^121\\.5(\\d+)", "^159\\.4(\\d+)", "^207\\.0(\\d+)"]
    def pricePatternsThirdBlock = ["^93\\.6(\\d+)", "^121\\.5(\\d+)", "^159\\.4(\\d+)", "^207\\.0(\\d+)"]
